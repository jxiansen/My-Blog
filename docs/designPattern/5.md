...
关于 Vuex 的细节，大家可以参考[Vuex 的官方文档](https://link.juejin.cn/?target=https%3A%2F%2Fvuex.vuejs.org%2Fzh%2F "https://vuex.vuejs.org/zh/")，此处提及 Vuex，除了为了拓宽大家的知识面，更重要的是为了说明单例模式在生产实践中广泛的应用和不可或缺的地位。如果对 Vuex 没有兴趣，那么大家只需关注“一个 Vue 应用只能对应一个 Store”这一点即可。
...
下面是 Store 类的构造函数的部分源码，完整源码请狠狠地[戳这里](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fvuejs%2Fvuex%2Fblob%2Fmain%2Fsrc%2Fstore.js "https://github.com/vuejs/vuex/blob/main/src/store.js")：
